    ...
    <footer className="bg-azul-profundo text-white mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-azul-cielo">Multi Impresiones AH</h3>
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              {/* WhatsApp */}
              <a
                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '50360528774'}`}
                target="_blank"
              ...
              {/* Facebook */}
              <a href="#" className="text-white/70 hover:text-blue-400 transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="#" className="text-white/70 hover:text-pink-400 transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10 py-4 text-center text-sm text-white/50">
        <p>© {new Date().getFullYear()} Multi Impresiones AH. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
