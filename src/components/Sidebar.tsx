...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="bg-azul-profundo text-white p-5 flex items-center justify-between">
        ...
        {/* Categories */}
        <div className="p-5">
          <h3 className="text-sm font-semibold text-azul-real uppercase tracking-wider mb-3">Categorías</h3>
          <ul className="space-y-1">
            <li>
              <Link
                href="/"
                onClick={onClose}
                className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-azul-profundo hover:bg-azul-palido transition-colors"
              >
        ...
        {/* Divider */}
        <div className="mx-5 border-t border-azul-cielo/30" />
        ...
        {/* Social */}
        <div className="p-5">
          <h3 className="text-sm font-semibold text-azul-real uppercase tracking-wider mb-3">Contáctanos</h3>
          <div className="flex items-center gap-4 px-3">
            ...
            {/* Instagram */}
            <a href="#" className="text-pink-500 hover:text-pink-600 transition-colors" aria-label="Instagram">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Phone */}
            <a href="tel:+50360528774" className="text-azul-brillante hover:text-azul-real transition-colors" aria-label="Teléfono">
